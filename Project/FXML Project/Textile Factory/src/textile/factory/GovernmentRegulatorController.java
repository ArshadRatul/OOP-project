 ...
 * @author Asus
 */
public class GovernmentRegulatorController implements Initializable {
    ...
    @FXML
    private void UpdateRuleButton(MouseEvent event) throws IOException {
         Parent NewParent = FXMLLoader.load(getClass().getResource("UpdateRules.fxml"));
