 ...
 * @author Asus
 */
public class CheckFeedbackController implements Initializable {

    @FXML
    private CheckBox Client;
    @FXML
    private CheckBox Suppliers;
    @FXML
    private CheckBox Government;
    ...
    @FXML
    private void Homebotton(MouseEvent event) throws IOException {
